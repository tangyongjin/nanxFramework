...
Ext.extend(Ext.ux.form.TimePickerField, Ext.form.Field, {
    ...
    setRawValue: function(v){
        if((v==undefined)||(v.h.length==0))
        {
        this.hoursSpinner.setValue(null);
        this.minutesSpinner.setValue(null);
        this.secondsSpinner.setValue(null);
        }
        else
        {      
    ...
    getValue: function(){
        ...
        if((v.h.length==0)||(v.m.length==0)||(v.s.length==0))
          {
