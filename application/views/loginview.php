<div class="m wbg shadow" id="login_main_form"  style="display:none;height:224px;width:550px;margin-top:100px;">
	<h1 style="font-size:16px;"><?php 
...
<div id="myModal" class="reveal-modal">
     ...
     <?php
      echo $this->lang->line('login_success');
      ?>
      </h1>
     <hr/>
     <br/>
